...
export const metadata: Metadata = {
	...
	openGraph: {
		...
		images: [
			{
				url: new URL(
					'https://res.cloudinary.com/doowhwdzj/image/upload/v1749262473/thumbnail_aafvs3.png'
				),
			},
		],
	},
...
export default function RootLayout({
	...
	return (
		<html lang="en">
			<body
				className={`${funnelDisplayLight.variable} ${funnelDisplayRegular.variable} 
      ...
      `}
			>
				<ReactLenis
					options={{ lerp: 0.1, duration: 1.7, smoothWheel: true }}
					root
				>
					<ThemeProvider>
						<Cursor />
